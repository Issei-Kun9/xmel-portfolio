...
seoTitle: "n8n Workflow Automation: 67-Node Lead Qualification"
description: "How to build an n8n lead qualification workflow — webhook triggers, GPT-4o-mini reasoning, and multi-channel outreach."
date: "2026-07-15"
readTime: "7 min read"
...
This post breaks down how I built a **67-node n8n workflow** that qualifies leads, makes voice calls, sends SMS messages, and books appointments — all automatically. It's the architecture behind both the [AI automation for real estate](/ai-automation-real-estate) and [AI automation for home services](/ai-automation-home-services) systems.
...
Want to see the qualification layer it feeds? Read [how an AI ISA qualifies leads in seconds](/blog/ai-isa-real-estate), or jump straight to the [real estate](/ai-automation-real-estate) or [home services](/ai-automation-home-services) build.
