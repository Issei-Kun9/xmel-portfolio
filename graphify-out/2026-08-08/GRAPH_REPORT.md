# Graph Report - my-portfolio  (2026-08-08)

## Corpus Check
- 48 files · ~25,264 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 303 nodes · 290 edges · 41 communities (23 shown, 18 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6d2b8f43`
...
Cohesion: 0.31
Nodes (7): CalculatorClient(), DISPOSABLE_DOMAINS, formatCurrency(), formatCurrencyFull(), isValidEmail(), Step, metadata
